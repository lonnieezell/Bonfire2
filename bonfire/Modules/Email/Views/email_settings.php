        ...
        <form action="/admin/settings/email" method="post">
            ...
            <fieldset x-data="{openTab: <?= $activeTab ?>}">
                ...
                <div class="row">
                    <div class="form-group col-12 col-sm-6 col-md-3">
                        ...
                        <select name="protocol" id="protocol" class="form-select">
                            <option value="smtp" @click="openTab = 3" <?php if (old('protocol', setting('Email', 'protocol')) === 'smtp') : ?> selected <?php endif?>>smtp</option>
                            <option value="mail" @click="openTab = 1" <?php if (old('protocol', setting('Email', 'protocol')) === 'mail') : ?> selected <?php endif?>>mail</option>
                            <option value="sendmail" @click="openTab = 2" <?php if (old('protocol', setting('Email', 'protocol')) === 'sendmail') : ?> selected <?php endif?>>sendmail</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="tab-content mx-5 mt-3">
                    ...
                    <!-- SMTP Settings -->
                    <div id="mail-settings" x-show="openTab === 3">
                        <!-- Host -->
