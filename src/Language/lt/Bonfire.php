...
return [
    'resourceNotFound'     => 'Nepavyko rasti {0}.',
    'resourceSaved'        => '{0} buvo įrašytas.',
    'resourcesSaved'       => '{0} buvo įrašyti.',
    'resourceDeleted'      => '{0} buvo ištrintas.',
    'resourcesDeleted'     => '{0} buvo ištrinti.',
    'resourceRestored'     => '{0} buvo atkurtas.',
    'unknownSaveError'     => 'Nežinoma klaida įrašant resursą ({0}).',
    ...
    'magicLinkInfo' => 'Mes išsiųsime el. laišką su nuoroda, kurią paspaudę galėsite prisijungti.',
